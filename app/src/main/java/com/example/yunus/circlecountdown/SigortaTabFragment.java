 ...
 */
public class SigortaTabFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        donutProgress.setText(String.valueOf(200));
        donutProgress.setProgress(200);
        ObjectAnimator anim = ObjectAnimator.ofInt(donutProgress, "progress", 0, 200); //0'dan farka kadar
