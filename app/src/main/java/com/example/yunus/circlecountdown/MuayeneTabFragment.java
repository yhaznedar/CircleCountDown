 ...
 */
public class MuayeneTabFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        donutProgress.setText(String.valueOf(80));
        donutProgress.setProgress(80);
        ObjectAnimator anim = ObjectAnimator.ofInt(donutProgress, "progress", 0, 80); //0'dan farka kadar
